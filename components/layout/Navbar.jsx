      ...
      <div className="max-w-7xl mx-auto ">
        ...
        >
                ...
                <div className="flex gap-8 items-center">
                  ...
                  <div className=" h-5 w-1 border-l border-black"></div>
...
//       <div
//         className={`bg-white w-full p-6 border-b border-black sticky top-0 z-10  ease-in-out duration-500 ${
//           animateHeader && "shadow-xl"
//         }`}
//       >
//         <div className="max-w-7xl mx-auto ">
...
//           >
//           <div className="flex max-w-screen-xl py-5 mx-auto items-center justify-between   ">
//         <div>
//           <img className="h-8" src="/logo.png" alt="logo" />
//         </div>
//         <div className="flex gap-8 items-center">
...
//   <path d="M8 11V7C8 5.66667 8.8 3 12 3C15.2 3 16 5.66667 16 7V11M8 11H5V21H19V11H16M8 11H16" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
//   </svg>
//             <p>For personnel</p>
//           </div>
//           <div className="flex gap-2">
...
//               <p>Support us</p>
//           </div>
//           <div className=" h-5 w-1 border-l border-black">
